...
## Dev Tools > Pipeline > 배포 전략 가이드 { #dev-tools-pipeline-deployment-strategy-guide }

배포 전략 가이드에서는 Pipeline의 스테이지를 조합하여 여러 가지 배포 전략을 수행하는 방법을 설명합니다.

<a id="bluegreen-deployment"></a>
## Blue/Green 배포 { #bluegreen-deployment }
...
### ReplicaSets 사용 { #use-replicasets }
...
[Pipeline 템플릿 가이드](./template-guide/)를 참고하여 파이프라인을 구성할 수 있습니다.
