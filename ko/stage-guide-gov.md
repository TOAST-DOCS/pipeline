...
- 배포를 실행하려는 아티팩트의 **Command Type**이 **SSH**인 경우 해당 **NHN Cloud Deploy 서비스 배포 실행** 기능을 지원하지 않으며, **Cloud Agent**인 경우에만 지원합니다. 관련된 내용은 [Deploy 사용 가이드](/Dev%20Tools/Deploy/ko/console-guide-gov/#_8)를 참고하세요.
...
자세한 설명은 [Deploy 사용 가이드](/Dev%20Tools/Deploy/ko/reference-gov/#_1)를 참고하세요.
