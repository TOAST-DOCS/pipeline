...
[Pipeline 콘솔 사용 가이드](./pipeline-management.md#_9)의 자동 실행 부분에 입력값에 대한 추가 가이드가 있습니다.
...
Blue/Green 배포를 위한 파이프라인을 구성할 수 있습니다. Blue/Green 배포는 [배포 전략 가이드](./deploy-strategy-guide.md)에서 자세한 내용을 확인할 수 있습니다.
```json
{
