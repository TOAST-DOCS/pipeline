...
**소스 저장소**는 **환경 설정**의 **소스 저장소 설정**에서 추가한 [소스 저장소](./environment-config.md#source-repository)를 선택할 수 있습니다. **브랜치**에는 빌드할 대상의 소스 브랜치를 입력합니다. 
...
사용자가 직접 구성한 Jenkins를 이용하여 빌드할 수 있습니다. **빌드 도구**는 **환경 설정**의 **빌드 도구 설정**에서 추가한 [빌드 도구](./environment-config.md#build-tool)를 선택할 수 있습니다. **빌드 잡**을 선택할 수 있습니다.
...
사용자가 직접 구성한 Helm package file 또는 [차트 저장소](./environment-config.md#chart-repository)를 이용하여 빌드할 수 있습니다.
...
- 소스 빌드 설정
    - **환경 설정**의 **이미지 저장소 설정**에서 추가한 [이미지 저장소](./environment-config.md#image-registry)를 선택할 수 있습니다.
...
- **환경 설정**의 **배포 대상 설정**에서 추가한 [배포 대상](./environment-config.md#deployment-target)을 선택할 수 있습니다.
...
- 소스 저장소
    - **환경 설정**의 **소스 저장소 설정**에서 추가한 [소스 저장소](./environment-config.md#source-repository)를 선택할 수 있습니다.
