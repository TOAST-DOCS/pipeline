...
In the **Container settings**, you must **add** one or more containers, see the [NCS guide](/Container/NCS/zh/user-guide)for a detailed explanation.
For a detailed description of **Workload Settings**, see the [NCS guide](/Container/NCS/zh/user-guide).
...
- If the **command type**of the artifact you want to run the deployment on is **SSH**, the **Run NHN Cloud Deploy Service Deployment** is not supported, only **Cloud Agent** is supported. For more information, refer to the [Deploy User Guide](https://docs.nhncloud.com/zh/Dev%20Tools/Deploy/zh/console-guide/#_8).
...
For more information, see the [Deploy User Guide](https://docs.nhncloud.com/zh/Dev%20Tools/Deploy/zh/reference/#_1).