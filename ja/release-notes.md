...
* **[配布 - Deploy]** ステージに **[リソースバージョン管理の使用]** オプションを追加
  * オプションを無効にすると、リソースはマニフェストで定義された元の名前のまま配布されます。
  * 詳細については、[Pipeline ステージガイド](/Dev%20Tools/Pipeline/ja/stage-guide/)を参照してください。
