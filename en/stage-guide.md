...
You can build using Jenkins with your own configuration. You can select [Build Tool](./environment-config.md#build-tool) you added in the **Build Tool Settings** in **Preferences**. You can select a **build job**.
...
You can build using a Helm package file or [Chart Repository](./environment-config.md#chart-repository)that users configured themselves.
...
- Source Build Settings
    - You can select the [image registry](./environment-config.md#image-registry) you added in the **Image Registry Settings** in **Environment Settings**.
...
- You can select the [deployment target](./environment-config.md#deployment-target) you added in **Deployment Target Settings** in **Environment Settings**. 
...
You can select the [deployment target](./environment-config.md#deployment-target) you added in **Deployment Target Settings** in **Environment Settings**. Enter **Namespace**, **Resource Type**, **Resource Name**, **Revision Back**. You can roll back to the specified Revision.
...
- Image registry
    - You can select the [Image Registry](./environment-config.md#image-registry) you added in **Image Registry Settings** of **Preferences**.
...
- Source repository
  - You can select the [Source Repository](./environment-config.md#source-repository) you added in **Source Repository Settings** of **Preferences**.
