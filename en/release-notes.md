...
* Added the API v1.1 guide for using User Access Key tokens.
  * For more information, see the [API v1.1 Guide](./api-guide-v1-1.md).

<a id="september-23-2025"></a>
### September 23, 2025 { #september-23-2025 }
* Added new stages. For more information, see the [Pipeline Stage Guide](./stage-guide.md).
...
* **Pipeline Notifications** feature has been added.
  ...
  * You can find how to use from [Pipeline Notification Guide](./pipeline-management.md#manage-a-pipeline).
...
* Changed the UI design of the **Pipeline Management** menu. See [Pipeline Management](./pipeline-management.md) for how to use.

<a id="may-28-2024"></a>
### May 28, 2024 { #may-28-2024 }
* Added new stages. You can learn how to use them in the [Pipeline Stage Guide](./stage-guide.md).
  * **Deployment - Disable**
  * **Deployment - Enable**
...
* Added the feature to dynamically select resource selection.
  * Applied Stages
    ...
    * **Deployment - Patch**
    * **Deployment - Scale**
* Added the **stage failure feature** to all stages. You can see how to use it in the [Pipeline Stage Guide](./stage-guide.md).
* You can use a blue/green deployment. You can learn how to use them in the [Deployment Strategy Guide](./deploy-strategy-guide.md).
...
* Added **Deployment - NHN Container Service**, a new deployment stage. See [Pipeline Stage Guide](./stage-guide.md).
...
* Added the **Deployment History Management** page, where you can view the history of pipeline runs and deployment target tasks. You can see how to use it in the [Deployment History Management Guide](./deploy-history-management.md).

<a id="december-19-2023"></a>
### December 19, 2023 { #december-19-2023 }
* The **Feature - NHN Cloud Deploy Service** stage has been added to run deployment scenarios of NHN Cloud Deploy. For how to use it, see [Pipeline Stage Guide](./stage-guide.md).
...
* Added the **Feature - Approval Management** stage that prevents subsequent stages from running without approval. For more information, see [Pipeline Stage Guide](./stage-guide.md).
...
* Deployment - Added the Deploy Target Management feature that allows you to check the output deployed to the Deploy stage. For more information, see [Pipeline User Guide](./deploy-target-monitoring.md).
...
* Added the chart repository settings available in the Build - Bake (Manifest) stage. For more details, see [Pipeline User Guide](./environment-config.md#chart-repository).
...
* Added an artifact feature that allows you to use external repository resources as start or end condtions for pipeline stages. You can find how to use in [Pipeline User Guide](./pipeline-management.md#create-a-pipeline)
...
* Made modifications so that, when running a pipeline without stages through the [API](./api-guide-v1-0.md#pipeline-manual-run), a failure response is returned.
...
* Added the connection check feature for the source repository, image registry, build tool, and deployment target. You can see how to use it in the [Pipeline User Guide](./environment-config.md). 
...
* Added GitLab to the source repository. You can find how to use it in the [Pipeline User Guide](./environment-config.md#source-repository).

<a id="january-25-2022"></a>
### January 25, 2022 { #january-25-2022 }
* Added an API to run Pipeline. You can find how to use it in the [Pipeline API Guide](./api-guide-v1-0.md).
